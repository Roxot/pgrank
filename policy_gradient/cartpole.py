...
# training loop
# stop when running reward exceeds 1000 (task is considered solved)
while episode_number <= max_steps and running_reward < 1000:
...
if running_reward > 1000:
    print "ep: {}: SOLVED! (running reward hit {} which is greater than 1000)".format(
